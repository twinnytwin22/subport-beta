...
const Sidebar = ({ session, children }: SidebarProps) => {
    const user = session?.user

    return (
        <aside className=" bg-gray-100 max-h-screen w-32 lg:w-64 px-4 py-4 dark:bg-black border border-r-1 text-white border-b border-zinc-200 dark:border-zinc-800 top-0 fixed eft-0 mx-auto items-center content-center justify-center">
