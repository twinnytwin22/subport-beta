  ...
  return (
    <div className="w-full flex max-w-6xl mx-auto">
      <div className="w-full lg:w-3/4">
              ...
              <div className="flex flex-wrap w-full md:ml-8 items-center">
                <div className="md:flex items-center hidden">
                  <div className="md:mr-2">
                    <Link
                      href={`/explore?view=${searchParams}`}
                      className={`inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300 ${pathName == '/explore' && 'text-blue-500'
                        }`}
                    >
                      Feed
                    </Link>
                  ...
                  <div className="md:mr-2">
                    <Link
                      ...
                      className={`inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300 ${pathName == '/explore/artists' && 'text-blue-500'
                        }`}
                    >
                      Artists
                    </Link>
                  ...
                  >
                    <div className="inline-block mt-1.5 pr-6 md:px-6  p-4 border-b-2 border-transparent rounded-t-lg hover:text-zinc-600 hover:border-zinc-300 dark:hover:text-zinc-300">
                ...
                <div className="flex items-center md:hidden px-4 pt-1">
                  <select
                    ...
                    id="feed-navigation"
                    className="bg-zinc-50 border border-zinc-300 text-zinc-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-40 p-1.5 dark:bg-zinc-950 dark:border-zinc-800 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                ...
                <div className="flex md:ml-4 p-4  justify-start space-x-4 items-center font-bold text-lg text-zinc-800 dark:text-zinc-200 h-fit">
                  ...
                  >
                    <BsViewStacked
                      className={`${!searchParams && 'text-blue-500'}`}
                    />
                  </p>
                  <p
                    className="cursor-pointer"
                    onClick={() => router.push(path + 'tile')}
                  >
                    {' '}
                    <TfiViewGrid
                      className={`${searchParams == 'tile' && 'text-blue-500'}`}
                    />
                  </p>
                  <p
                    className="cursor-pointer"
                  ...
                  >
                    <TfiViewList
                      className={`${searchParams == 'list' && 'text-blue-500'}`}
                    />
                  </p>
                </div>
              </div>
        ...
        <div className="mt-24 relative z-0 mx-auto">{children}</div>
      </div>
