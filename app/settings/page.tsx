...
function Page() {
    ...
    return !isLoading && (
        <div className="w-full min-h-[70vh] max-h-[80vh] mt-4 lg:mt-8 flex justify-center content-center mb-24 md:mb-0">
            <div className={`flex min-h-full max-h-[70vh] overflow-y-scroll items-center bg-white dark:bg-black w-full max-w-4xl mx-auto justify-between rounded-md border-zinc-300 dark:border-zinc-700 md:border relative`}>
