...
function SubscriberForm({ close, sub, isAuthedUser }: any) {
    ...
    return (
        <div id="subscriber-form-container" className="bg-white dark:bg-black p-8 rounded-lg shadow-lg border-zinc-200 dark:border-zinc-700 border max-w-md w-full scale-90 md:scale-100 z-[9999]">
