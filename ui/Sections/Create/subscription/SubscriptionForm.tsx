...
function SubscriptionForm() {
    ...
    const onSubmit = async (data: any) => {
        try {
            // Store the subscription data in Supabase
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                    <div onClick={handleCampaignModal}
                        ...
                        className="bg-blue-600 dark:bg-blue-700 text-center hover:bg-blue-700 dark:hover:bg-blue-600 text-white font-bold py-2 px-4 rounded w-full"
                    >
                ...
                <button
                    type="submit"
                    className="bg-blue-600 dark:bg-blue-700 text-center hover:bg-blue-700 dark:hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"
                >
                    Create Subscription
                </button>
            </form>
