        ...
        <div className="block space-y-2 mt-2 mx-auto relative max-w-52 text-small">
            ...
            {creatingPlaylist && <div className='w-full min-w-52 space-y-2'>
                <input
                    ...
                    className="bg-zinc-50 border border-zinc-300 text-zinc-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-zinc-800 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
