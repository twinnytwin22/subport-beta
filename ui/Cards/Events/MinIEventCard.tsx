        ...
        <div className=''>
            ...
            >                <div className="flex justify-between">
                    ...
                    <Link className='w-fit' href={`/events/${event?.slug}`}>
                        <div className=" hover:ring  h-fit hover:ring-blue-700 text-center  text-black dark:text-white font-bold hover:shadow-md  shadow text-xs px-2.5 py-2.5 rounded-md  sm:mr-2 mb-1 ease-linear transition-all duration-150 w-24">
                            {event.ticket_status}
                        </div>
                    </Link>
