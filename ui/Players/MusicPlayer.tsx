    ...
    <div className="block max-w-sm m-6 p-6 bg-white border border-gray-200 rounded-2xl shadow  dark:bg-gray-800 dark:border-gray-700 relative">
      ...
      <div className="mt-4">
        ...
        <div className="w-full">
          <input
            type="range" className=" accent-red-300 h-2.5 rounded-full w-full"
            min="0"
        ...
        <div className="flex mt-4 w-64 mx-10">
          ...
          <svg onClick={handleBackClick} className="text-black dark:text-white bg-white dark:bg-gray-800 w-24 h-16 rounded-full p-2 m-2 "
          ...
          >
            {isPlaying ?
              ...
              (<svg fill="none" className="rounded-full"
                stroke="currentColor"
                strokeWidth={1.5}
                viewBox="0 0 24 24"
          ...
          <svg onClick={handleNextClick} fill="none" className="text-black p-2 dark:text-white bg-white  dark:bg-gray-800 w-24 h-16 rounded-full m-2"
            stroke="currentColor"
            strokeWidth={1.5} viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true">
          ...
          <svg fill="none" className="text-black dark:text-white p-2 bg-white  dark:bg-gray-800 w-24 h-16 rounded-full m-2"
            stroke="currentColor"
            strokeWidth={1.5}
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
