            ...
            <footer className=" cursor-pointer sm:cursor-default" >
                <div className="fixed bottom-16 sm:bottom-0 left-0 right-0 z-[250] border-zinc-200 dark:border-zinc-800 px-6 py-2.5 border-t w-full bg-zinc-100 dark:bg-black ">
                    <div className="z-[300]   px-6 py-2.5  mx-auto relative sm:pl-32 lg:pl-64 items-center place-items-center h-12">
                        {audioRef && audioUrl &&
                            <div onClick={toggleDrawer} className="flex items-center justify-between max-w-screen-xl mx-auto w-full">
                                <audio
                                    ref={audioRef}
                                    id="music-player"
                                    controls={false}
                        ...
                        {isDrawerOpen && screenWidth < 640 && (
                            <div className="fixed bottom-32 sm:bottom-16 -mb-1 left-0 right-0 h-2/3 sm:pl-36 z-[400] border-t border-b bg-white dark:bg-black px-6 py-4 border-zinc-200 dark:border-zinc-800 overflow-hidden">
                                <div
