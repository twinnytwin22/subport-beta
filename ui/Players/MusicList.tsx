            ...
            <div className="relative overflow-hidden bg-white shadow-md dark:bg-zinc-950 sm:rounded-lg w-full border border-zinc-200 dark:border-zinc-800">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left text-zinc-500 dark:text-zinc-400">
                        ...
                        <tbody>
                            <tr className="border-b dark:border-zinc-600 hover:bg-zinc-100 dark:hover:bg-zinc-700 text-xs md:text-sm">
                                ...
                                <td className="px-4 py-2 font-medium text-zinc-900 whitespace-nowrap dark:text-white">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-1 text-zinc-500 dark:text-zinc-400">5.0</span>
                                    </div>
                                </td> </tr>
