  ...
  return (
    user && (
      <footer className="cursor-pointer sm:cursor-default">
        <div
          className={`fixed bottom-16 sm:bottom-0 left-0 right-0 z-[250] border-zinc-200 dark:border-zinc-800 md:px-6 py-2.5 border-t w-full bg-zinc-100 dark:bg-black ${audioRef && audioUrl ? 'block' : 'hidden md:block'
            }`}
        >
            ...
            {audioRef && audioUrl && (
              <div className="player-drawer flex items-center justify-between max-w-screen-xl mx-auto w-full">
                ...
                <div className="px-4 text-xs w-full flex flex-col md:w-40 min-w-[150px] relative">
                  ...
                  />
                  <h3
                    className={`scrolling-text-div ${metaData?.artist_name?.length > 12
                ...
                <div className="mx-auto w-full space-x-4 relative flex items-center ">
                  {!imageUrl ? (
                    <div
                      ...
                      className="max-w-[30px] h-[30px] rounded-md bg-blue-300 w-full"
                    ></div>
                  ) : (
                    <Image
                      src={imageUrl}
            ...
            {isDrawerOpen && screenWidth < 640 && (
              <div className="player-drawer fixed bottom-32 sm:bottom-16 -mb-1 left-0 right-0 h-2/3 sm:pl-36 z-[400] border-t border-b bg-white dark:bg-black px-6 py-4 border-zinc-200 dark:border-zinc-800 overflow-hidden">
                ...
                <div className="relative p-8 items-center">
                  <p
                    className="cursor-pointer w-fit p-2 border border-zinc-500 rounded text-sm"
                    onClick={closeDrawer}
                  >
                    Close
                  </p>
                  ...
                  <div className="aspect-square object-cover max-w-xs mx-auto">
                    {!imageUrl ? (
                      ...
                      <Image
                        ...
                        height={300}
                        blurDataURL={'/images/stock/blur.png'}
                        className="mx-auto rounded-md aspect-square object-cover min-w-full"
                      />
                    )}
                  </div>
